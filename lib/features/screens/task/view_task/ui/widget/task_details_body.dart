    ...
    return BlocConsumer<TaskDetailsCubit, TaskDetailsState>(
      listener: (context, state) {
        ...
        if (state is GetChangeTaskStatusSuccessState) {
          toast(text: state.changeTaskStatusModel.message!, color: Colors.blue);
          cubit.getTaskDetails(widget.id);
          cubit.getAllUsers();
        }
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (task.comment != null ||
                              (task.files != null && task.files!.isNotEmpty)) {
                            return Container(
