...
import 'package:smart_cleaning_application/features/screens/setting/technical_support/logic/technical_support_cubit.dart';
import 'package:smart_cleaning_application/features/screens/setting/technical_support/logic/technical_support_state.dart';
import 'package:smart_cleaning_application/features/screens/setting/technical_support/ui/widgets/upload_files_dialog.dart';
...
class _TechnicalSupportScreenState extends State<TechnicalSupportScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text('Technical Support'), leading: CustomBackButton()),
      body: BlocProvider(
