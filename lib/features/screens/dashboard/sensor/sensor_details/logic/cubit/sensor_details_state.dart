...
//********************************** */
class GetAllTasksLoadingState extends SensorDetailsState {}

class GetAllTasksSuccessState extends SensorDetailsState {
  final AllTasksModel allTasksModel;

  GetAllTasksSuccessState(this.allTasksModel);
}

class GetAllTasksErrorState extends SensorDetailsState {
  final String error;
