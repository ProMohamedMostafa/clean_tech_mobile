...
import 'package:smart_cleaning_application/features/screens/dashboard/sensor/sensor_details/ui/widget/list_item_build.dart';
    ...
    return Scaffold(
      ...
      body: BlocConsumer<SensorDetailsCubit, SensorDetailsState>(
        ...
        builder: (context, state) {
          if (cubit.sensorDetailsModel == null || cubit.allTasksModel == null) {
            return Loading();
          }
          final itemCount = cubit.allTasksModel?.data?.data?.length ?? 0;
                ...
                child: Column(
                    ...
                    children: [
                              ...
                              child: Stack(
                                children: <Widget>[
                                  AnimatedPositioned(
                                    ...
                                    bottom: 0,
                                    left:
                                        cubit.isSensorEnabled ? 23.0.w : 0.0.w,
                                    right:
                                        cubit.isSensorEnabled ? 0.0.w : 23.0.w,
                      ...
                      rowDetailsBuild(
                        ...
                        color:
                            ((cubit.sensorDetailsModel?.data?.battery ?? 0)) >=
                                    50
                                ? Colors.green
                                : Colors.deepOrange,
                      ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    cubit.sensorDetailsModel?.data?.limit
                                            ?.key ??
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                cubit.updateSelectedTreeIndex(index, id);
                              },
