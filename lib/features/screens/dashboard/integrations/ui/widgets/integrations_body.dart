...
import 'package:smart_cleaning_application/features/screens/dashboard/integrations/ui/widgets/itegration_item.dart';
...
class IntegrationsBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<IntegrationItem> integrationItems = [
      ...
      if (role == 'Admin')
        IntegrationItem(
            onTap: () => context.pushNamed(Routes.chooseViewAssignScreen),
