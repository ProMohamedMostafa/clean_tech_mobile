...
import 'package:smart_cleaning_application/features/screens/dashboard/shift/shifts_management/ui/widgets/shift_list_item_build.dart';
...
class ShiftListDetailsBuild extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final shiftsData = cubit.selectedIndex == 0
        ? cubit.allShiftsModel?.data?.data
