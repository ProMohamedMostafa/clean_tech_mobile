...
class AudiorAnswerDetailsScreen extends StatelessWidget {
  final int id;
  const AudiorAnswerDetailsScreen({super.key, required this.id});
    ...
    return Scaffold(
      ...
      body: BlocBuilder<UserDetailsCubit, UserDetailsState>(
        builder: (context, state) {
          final questions = cubit.auditorAnswerDetailsModel?.data?.questions;
