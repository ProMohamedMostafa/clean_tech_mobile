class DeviceAnswersModel {
  ...
  DeviceAnswersModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    succeeded = json['succeeded'];
    if (json['data'] != null) {
      data = <DeviceAnswersData>[];
      json['data'].forEach((v) {
        data!.add(DeviceAnswersData.fromJson(v));
      });
    }
  }
...
class DeviceAnswersData {
  ...
  DeviceAnswersData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    date = json['date'];
    time = json['time'];
