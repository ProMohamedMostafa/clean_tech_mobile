...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <StatisticsData>[];
      json['data'].forEach((v) {
        data!.add(StatisticsData.fromJson(v));
      });
    }
  }
...
class StatisticsData {
  ...
  StatisticsData.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    totalSensor = json['totalSensor'];
    totalDevice = json['totalDevice'];
    totalAnswer = json['totalAnswer'];
    totalAuditor = json['totalAuditor'];
    totalCleaner = json['totalCleaner'];
    rate = json['rate'];
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['name'] = name;
    data['totalSensor'] = totalSensor;
    data['totalDevice'] = totalDevice;
    data['totalAnswer'] = totalAnswer;
    data['totalAuditor'] = totalAuditor;
    data['totalCleaner'] = totalCleaner;
    data['rate'] = rate;
    return data;
  }
}
