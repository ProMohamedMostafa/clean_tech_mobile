...
class EditChoicesBody extends StatelessWidget {
  final int selectedTabIndex;
  const EditChoicesBody({super.key, required this.selectedTabIndex});
  @override
  ...
  Widget _buildChoicesList(EditQuestionCubit cubit, BuildContext context) {
    return SizedBox(
      height: 400,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildFilePreview(
      BuildContext context, EditQuestionCubit cubit, int index) {
    final file = cubit.choiceImages[index];
