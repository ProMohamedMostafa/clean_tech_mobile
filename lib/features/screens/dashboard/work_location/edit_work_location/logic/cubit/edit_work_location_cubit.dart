...
//****************************************************************************************** */
  ...
  void initializeOrganizationControllers() {
    if (organizationUsersShiftsDetailsModel != null &&
        usersModel != null &&
        shiftModel != null) {
      // Initialize managers
      final managers = usersModel!.data!.users!
      ...
      allManagersController.setItems(managers);
      selectedManagersIds = organizationUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Manager')
          .map((user) => user.id!)
          .toList();
      allManagersController
      ...
      allSupervisorsController.setItems(supervisors);
      selectedSupervisorsIds = organizationUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Supervisor')
          .map((user) => user.id!)
          .toList();
      allSupervisorsController.selectWhere(
      ...
      allCleanersController.setItems(cleaners);
      selectedCleanersIds = organizationUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Cleaner')
          .map((user) => user.id!)
          .toList();
      allCleanersController
      ...
      final shifts = shiftModel!.data!.data!
          .map((shift) => DropdownItem(
                label: shift.name ?? 'Unnamed Shift',
                value: ShiftItem(
                  id: shift.id,
                  name: shift.name,
      ...
      selectedShiftsIds = organizationUsersShiftsDetailsModel!.data!.shifts
              ?.map((shift) => shift.id ?? 0)
              .where((id) => id != 0)
              .toList() ??
          [];
      allShiftsController
  ...
  void initializeBuildingControllers() {
    if (buildingUsersShiftsDetailsModel != null &&
        usersModel != null &&
        shiftModel != null) {
      // Initialize managers
      final managers = usersModel!.data!.users!
      ...
      allManagersController.setItems(managers);
      selectedManagersIds = buildingUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Manager')
          .map((user) => user.id!)
          .toList();
      allManagersController
      ...
      allSupervisorsController.setItems(supervisors);
      selectedSupervisorsIds = buildingUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Supervisor')
          .map((user) => user.id!)
          .toList();
      allSupervisorsController.selectWhere(
      ...
      allCleanersController.setItems(cleaners);
      selectedCleanersIds = buildingUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Cleaner')
          .map((user) => user.id!)
          .toList();
      allCleanersController
      ...
      selectedShiftsIds = buildingUsersShiftsDetailsModel!.data!.shifts
              ?.map((shift) => shift.id ?? 0)
              .where((id) => id != 0)
              .toList() ??
          [];
  ...
  void initializeFloorControllers() {
    if (floorUsersShiftsDetailsModel != null &&
        usersModel != null &&
        shiftModel != null) {
      // Initialize managers
      final managers = usersModel!.data!.users!
      ...
      allManagersController.setItems(managers);
      selectedManagersIds = floorUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Manager')
          .map((user) => user.id!)
          .toList();
      allManagersController
      ...
      allSupervisorsController.setItems(supervisors);
      selectedSupervisorsIds = floorUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Supervisor')
          .map((user) => user.id!)
          .toList();
      allSupervisorsController.selectWhere(
      ...
      allCleanersController.setItems(cleaners);
      selectedCleanersIds = floorUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Cleaner')
          .map((user) => user.id!)
          .toList();
      allCleanersController
      ...
      selectedShiftsIds = floorUsersShiftsDetailsModel!.data!.shifts
              ?.map((shift) => shift.id ?? 0)
              .where((id) => id != 0)
              .toList() ??
          [];
  ...
  void initializeSectionControllers() {
    if (sectionUsersShiftsDetailsModel != null &&
        usersModel != null &&
        shiftModel != null) {
      // Initialize managers
      final managers = usersModel!.data!.users!
      ...
      allManagersController.setItems(managers);
      selectedManagersIds = sectionUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Manager')
          .map((user) => user.id!)
          .toList();
      allManagersController
      ...
      allSupervisorsController.setItems(supervisors);
      selectedSupervisorsIds = sectionUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Supervisor')
          .map((user) => user.id!)
          .toList();
      allSupervisorsController.selectWhere(
      ...
      allCleanersController.setItems(cleaners);
      selectedCleanersIds = sectionUsersShiftsDetailsModel!.data!.users!
          .where((user) => user.role == 'Cleaner')
          .map((user) => user.id!)
          .toList();
      allCleanersController
      ...
      selectedShiftsIds = sectionUsersShiftsDetailsModel!.data!.shifts
              ?.map((shift) => shift.id ?? 0)
              .where((id) => id != 0)
              .toList() ??
          [];
