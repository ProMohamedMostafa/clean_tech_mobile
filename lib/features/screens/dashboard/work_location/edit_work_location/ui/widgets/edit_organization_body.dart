...
class EditOrganizationBody extends StatelessWidget {
  final int id;
    ...
    return Scaffold(
      ...
      body: BlocConsumer<EditWorkLocationCubit, EditWorkLocationState>(
        ...
        builder: (context, state) {
          if (cubit.organizationUsersShiftsDetailsModel == null ||
...
// Initialize controllers when data is ready
          WidgetsBinding.instance.addPostFrameCallback((_) {
            cubit.initializeOrganizationControllers();
          });
          return Padding(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomDropDownList(
                      hint: cubit.organizationUsersShiftsDetailsModel!.data!
                          .countryName!,
                    ...
                    CustomDropDownList(
                      hint: cubit
                          .organizationUsersShiftsDetailsModel!.data!.areaName!,
                    ...
                    CustomDropDownList(
                      hint: cubit
                          .organizationUsersShiftsDetailsModel!.data!.cityName!,
