...
import 'package:smart_cleaning_application/features/screens/dashboard/work_location/work_location_details/ui/widgets/work_location_users/supervisors/build_supervisors_item_list.dart';
import 'package:smart_cleaning_application/generated/l10n.dart';

class WorkLocationSupervisors extends StatelessWidget {
  final int selectedIndex;
  const WorkLocationSupervisors({super.key, required this.selectedIndex});
    ...
    if (usersData == null || usersData.isEmpty) {
      ...
      return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return BuildSupervisorsItemList(selectedIndex: selectedIndex,index: index,);
        },
      );
    }
  }
