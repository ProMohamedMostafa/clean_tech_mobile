...
class WorkLocationListItemShift extends StatelessWidget {
  ...
  const WorkLocationListItemShift(
      ...
      onTap: () async {
        final result = await context.pushNamed(Routes.shiftDetailsScreen,
            arguments: selectedIndex == 2
                ? cubit
                    .organizationUsersShiftDetailsModel!.data!.shifts![index].id
                : selectedIndex == 3
                    ? cubit
                        .buildingUsersShiftDetailsModel!.data!.shifts![index].id
                    : selectedIndex == 4
                        ? cubit.floorUsersShiftDetailsModel!.data!
                            .shifts![index].id
                        : selectedIndex == 5
                            ? cubit.sectionUsersShiftDetailsModel!.data!
                                .shifts![index].id
                            : null);

        if (result == true) {
          selectedIndex == 2
              ? cubit.getOrganizationUsersDetails(cubit
                  .organizationUsersShiftDetailsModel!.data!.shifts![index].id!)
              : selectedIndex == 3
                  ? cubit.getBuildingUsersDetails(cubit
                      .buildingUsersShiftDetailsModel!.data!.shifts![index].id!)
                  : selectedIndex == 4
                      ? cubit.getFloorUsersDetails(cubit
                          .floorUsersShiftDetailsModel!
                          .data!
                          .shifts![index]
                          .id!)
                      : cubit.getSectionUsersDetails(cubit
