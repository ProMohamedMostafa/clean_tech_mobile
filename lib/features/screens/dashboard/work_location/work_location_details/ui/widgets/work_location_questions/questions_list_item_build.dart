...
class QuestionsListItemBuild extends StatelessWidget {
  final int index;
  final int selectedIndex
; 

  const QuestionsListItemBuild({
    super.key,
    required this.index,
  ...
  Widget build(BuildContext context) {
    final cubit = context.watch<WorkLocationDetailsCubit>();
    final isSelected = cubit.selectedItems[index];
    final isExpanded = cubit.expandedItems[index];

    final question = selectedIndex == 5
        ? cubit.sectionQuestionsModel!.data!.data![index]
        : cubit.pointQuestionsModel!.data!.data![index];
