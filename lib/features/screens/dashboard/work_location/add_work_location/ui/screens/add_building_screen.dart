...
class AddBuildingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          leading: CustomBackButton(), title: Text(S.of(context).addBuilding)),
  ...
  Widget _buildDetailsField(BuildContext context, AddWorkLocationCubit cubit) {
    return Column(
        ...
        children: [
          ...
          CustomTextFormField(
            controller: cubit.addBuildingController,
            onlyRead: false,
            hint: '',
            keyboardType: TextInputType.text,
            validator: (value) {
          ...
          CustomDescriptionTextFormField(
            controller: cubit.buildingDiscriptionController,
  ...
  Widget _buildContinueButton(BuildContext context, AddWorkLocationCubit cubit,
    ...
    return state is CreateBuildingLoadingState
        ? Loading()
        : DefaultElevatedButton(
            name: S.of(context).addButton,
            onPressed: () {
              if (cubit.formKey.currentState!.validate()) {
                cubit.createBuilding();
              }
            },
