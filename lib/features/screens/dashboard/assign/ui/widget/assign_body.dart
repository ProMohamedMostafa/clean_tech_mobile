  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body:
          ...
          if (index == 0) {
            isLoading = cubit.shiftModel == null || cubit.roleModel == null;
          } else if (index == 1) {
            isLoading =
                cubit.organizationModel == null || cubit.shiftModel == null;
          } else if (index == 2) {
            isLoading = cubit.usersModel == null || cubit.areaListModel == null;
          }
          return Skeletonizer(
            enabled: isLoading,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                  ...
                                  if (cubit.shouldShow('Organization')) ...[
                                    ...
                                    BlocBuilder<AssignCubit, AssignStates>(
                                      buildWhen: (previous, current) =>
                                          ...
                                          current
                                              is AllOrganizationSuccessState,
                                      builder: (context, state) {
                                ...
                                // role + multi users
                                if (index == 2 &&
                                    cubit.usersModel?.data?.users != null) ...[
                                  Text(
                                ...
                                if (index == 0) ...[
                                  ...
                                  if (cubit.roleController.text.isNotEmpty) ...[
                                    ...
                                    CustomDropDownList(
                                      ...
                                      keyboardType: TextInputType.text,
                                      suffixIcon: IconBroken.arrowDown2,
                                      hint: (cubit.roleIdController.text ==
                                                  '1' ||
                                ...
                                if (index == 0 || index == 1) ...[
                                  ...
                                  CustomMultiDropdown(
                                    items:
                                        cubit.shiftModel?.data?.data?.isEmpty ??
                                                true
                                            ? [
                                                DropdownItem(
                                                  label: S
