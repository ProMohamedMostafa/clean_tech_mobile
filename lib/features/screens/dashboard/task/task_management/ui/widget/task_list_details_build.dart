...
import 'package:smart_cleaning_application/features/screens/dashboard/task/task_management/ui/widget/list_item_build.dart';
...
class TaskListBuild extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (cubit.selectedIndex == 8) {
      if (cubit.deleteTaskListModel == null) {
        return const Center(child: Loading());
      }
    } else {
      if (cubit.allTasksModel == null) {
        return const Center(child: Loading());
      }
    }
