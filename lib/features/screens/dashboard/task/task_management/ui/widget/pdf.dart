...
Future<void> createTaskPDF(BuildContext context) async {
  final cubit = context.read<TaskManagementCubit>();
  final users = cubit.allTasksModel?.data?.data ?? [];
  ...
  header.cells[1].value = 'Priority';
  header.cells[2].value = 'Status';
  header.cells[3].value = 'CreatedBy';
  header.cells[4].value = 'Start Date';
  header.cells[5].value = 'End Date';
  header.cells[6].value = 'Start Time';
  header.cells[7].value = 'End Time';

  // ======= Dynamic Rows from API =======
  for (final user in users) {
    final row = grid.rows.add();
    row.cells[0].value = user.title ?? '';
    row.cells[1].value = user.status ?? '';
    row.cells[2].value = user.priority ?? '';
    row.cells[3].value = user.createdUserName ?? '';
    row.cells[4].value = user.startDate ?? '';
    row.cells[5].value = user.endDate ?? '';
    row.cells[6].value = user.startTime ?? '';
    row.cells[7].value = user.endTime ?? '';
  }
