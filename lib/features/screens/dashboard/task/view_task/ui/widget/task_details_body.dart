...
import 'package:smart_cleaning_application/features/screens/dashboard/task/view_task/ui/widget/current_read_dialog_.dart';
import 'package:smart_cleaning_application/features/screens/dashboard/task/view_task/ui/widget/upload_files_dialog.dart';
...
class _TaskDetailsBodyState extends State<TaskDetailsBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<TaskDetailsCubit, TaskDetailsState>(
      ...
      builder: (context, state) {
        ...
        final bool isTeamTask = widget.selectedIndex == 2;
        ...
        return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                (role == 'Cleaner' ||
                        (role != 'Admin' &&
                            cubit.taskDetailsModel!.data!.createdBy != uId) ||
                        isTeamTask)
                    ? SizedBox.shrink()
                    : IconButton(
                        onPressed: () async {
                ...
                child: Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  style:
                                      TextStyles.font11WhiteSemiBold.copyWith(
                                    color: cubit.priorityColorForTask,
                                  ),
                                ),
                              ),
                        ...
                        verticalSpace(3),
                        Divider(),
                        if (cubit.taskDetailsModel!.data!.createdUserName !=
                                null ||
                        ...
                        Divider(),
                        if (cubit.taskDetailsModel?.data?.currentReading !=
                            null) ...[
                          rowDetailsBuild(
                            context,
                            S.of(context).currently_reading,
                            cubit.taskDetailsModel!.data!.currentReading
                                .toString(),
                          ),
                          Divider()
                        ],
                        if (cubit.taskDetailsModel?.data?.readingAfter !=
                            null) ...[
                          rowDetailsBuild(
                            context,
                            S.of(context).after_reading,
                            cubit.taskDetailsModel!.data!.readingAfter
                                .toString(),
                          ),
                          Divider()
                        ],
                              ...
                              onTap: () {
                                (uId ==
                                    ...
                                    : context.pushNamed(
                                        ...
                                        arguments: cubit.taskDetailsModel!.data!
                                            .users![index].id,
                                      );
                              },
                              child: Container(
                        ...
                        if (cubit.taskDetailsModel!.data!.files!.isNotEmpty)
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount:
                                  cubit.taskDetailsModel!.data!.files!.length,
                        ...
                        cubit.taskDetailsModel!.data!.comments!.every((task) =>
                            ...
                            : ListView.separated(
                                ...
                                itemCount: cubit
                                    .taskDetailsModel!.data!.comments!.length,
                                separatorBuilder: (context, index) =>
                                    verticalSpace(8),
                                itemBuilder: (context, index) {
                                  final task = cubit
                                      .taskDetailsModel!.data!.comments![index];
                                        ...
                                        onPressed: () {
                                          if (cubit.formKey.currentState!
                                            ...
                                            taskCubit.addComment(
                                              imagePath,
                                              widget.id,
                                              taskCubit.taskDetailsModel!.data!
                                                  .statusId!,
                                            );
                                          }
                                        },
                                    ...
                                    (role == 'Cleaner' ||
                                            (role != 'Admin' &&
                                                cubit.taskDetailsModel!.data!
                                                        .createdBy !=
                                                    uId))
                                        ? _buildCleanerButtons(cubit, context)
                                        : _buildAdminButtons(cubit, context),
                                  ],
                                ),
                          verticalSpace(20)
                        ],
  ...
  Widget _buildCleanerButtons(TaskDetailsCubit cubit, BuildContext context) {
    final statusId = cubit.taskDetailsModel!.data!.statusId!;
          ...
          children: [
            Expanded(
              child: DefaultElevatedButton(
                name: S.of(context).startButton,
                onPressed: () {
                  cubit.changeTaskStatus(widget.id, 1);
                },
                color: AppColor.primaryColor,
      ...
      case 6:
        return Row(
          ...
          children: [
            Expanded(
              child: DefaultElevatedButton(
                name: S.of(context).completeButton,
                onPressed: () {
                  cubit.taskDetailsModel!.data!.currentReading == null
                      ? cubit.changeTaskStatus(widget.id, 2)
            ...
            Expanded(
              child: DefaultElevatedButton(
                name: S.of(context).notresolvedButton,
                onPressed: () {
                  cubit.changeTaskStatus(widget.id, 5);
                },
      ...
      case 5:
        return Row(
          ...
          children: [
            Expanded(
              child: DefaultElevatedButton(
                name: S.of(context).reStartButton,
                onPressed: () {
                  cubit.changeTaskStatus(widget.id, 1);
                },
                color: AppColor.primaryColor,
  ...
  Widget _buildAdminButtons(TaskDetailsCubit cubit, BuildContext context) {
    final statusId = cubit.taskDetailsModel!.data!.statusId!;
          ...
          children: [
            Expanded(
              child: DefaultElevatedButton(
                name: S.of(context).completeButton,
                onPressed: () {
                  cubit.changeTaskStatus(widget.id, 3);
                },
                color: AppColor.primaryColor,
                textStyles: TextStyles.font16WhiteSemiBold,
              ),
          ...
          children: [
            ...
            Expanded(
              child: DefaultElevatedButton(
                ...
                onPressed: () {
                  cubit.changeTaskStatus(widget.id, 4);
                },
                color: AppColor.secondaryColor,
                textStyles: TextStyles.font16WhiteSemiBold,
              ),
