                                      ...
                                      : selectedIndex == 1
                                          ...
                                          : selectedIndex == 2
                                              ? cubit.restoreDeletedOrganization(cubit
                                                  ...
                                                  .id!)
                                              : selectedIndex == 3
                                                  ? cubit.restoreDeletedBuilding(
                                                      cubit.deletedBuildingList!
                                                          .data![index].id!)
                                                  : selectedIndex == 4
                                                      ? cubit.restoreDeletedFloor(
                                                          cubit
                                                              .deletedFloorList!
                                                              .data![index]
                                                              .id!)
                                      ...
                                      : selectedIndex == 1
                                          ...
                                          : selectedIndex == 2
                                              ? cubit.forcedDeletedOrganization(cubit
                                                  ...
                                                  .id!)
                                              : selectedIndex == 3
                                                  ? cubit.forcedDeletedBuilding(
                                                      cubit.deletedBuildingList!
                                                          .data![index].id!)
                                                  : selectedIndex == 4
                                                      ? cubit.forcedDeletedFloor(
                                                          cubit
                                                              .deletedFloorList!
                                                              .data![index]
                                                              .id!)
