...
class UserTaskDetailsLoadingState extends WorkLocationDetailsState {}

class UserTaskDetailsSuccessState extends WorkLocationDetailsState {
  final AllTasksModel workLocationTaskDetailsModel;

  UserTaskDetailsSuccessState(this.workLocationTaskDetailsModel);
}

class UserTaskDetailsErrorState extends WorkLocationDetailsState {
  final String error;
