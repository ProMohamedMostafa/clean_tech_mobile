...
class EditListOrganizationTextFormField extends StatefulWidget {
  ...
  const EditListOrganizationTextFormField({
    super.key,
    required this.items,
  ...
  @override
  State<EditListOrganizationTextFormField> createState() =>
      _OrganizationTextFormFieldState();
}

class _OrganizationTextFormFieldState extends State<EditListOrganizationTextFormField> {
