...
class EditListAreaTextFormField extends StatefulWidget {
  ...
  const EditListAreaTextFormField({
    super.key,
    required this.items,
  ...
  @override
  State<EditListAreaTextFormField> createState() => _AreaTextFormFieldState();
}

class _AreaTextFormFieldState extends State<EditListAreaTextFormField> {
