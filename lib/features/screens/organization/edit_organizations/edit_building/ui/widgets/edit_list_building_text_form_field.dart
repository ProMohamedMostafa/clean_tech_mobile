...
class EditListBuildingTextFormField extends StatefulWidget {
  ...
  const EditListBuildingTextFormField({
    super.key,
    required this.items,
  ...
  @override
  State<EditListBuildingTextFormField> createState() => _BuildingTextFormFieldState();
}

class _BuildingTextFormFieldState extends State<EditListBuildingTextFormField> {
