...
class EditListCityTextFormField extends StatefulWidget {
  ...
  const EditListCityTextFormField({
    super.key,
    required this.items,
  ...
  @override
  State<EditListCityTextFormField> createState() => _CityTextFormFieldState();
}

class _CityTextFormFieldState extends State<EditListCityTextFormField> {
