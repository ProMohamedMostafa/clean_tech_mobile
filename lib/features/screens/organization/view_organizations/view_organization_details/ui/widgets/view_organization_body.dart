...
import 'package:smart_cleaning_application/features/screens/organization/view_organizations/view_organization_details/ui/widgets/row_details_build.dart';
    ...
    return Scaffold(
      ...
      body: BlocConsumer<OrganizationsCubit, OrganizationsState>(
        ...
        builder: (context, state) {
          return state is OrganizationDetailsLoadingState
              ? Center(
