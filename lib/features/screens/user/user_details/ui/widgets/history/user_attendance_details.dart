...
import 'package:smart_cleaning_application/features/screens/user/user_details/ui/widgets/history/attendance_list_item_build.dart';
                  ...
                  return BlocProvider(
                    ...
                    child: FilterDialogWidget(
                      ...
                      onPressed: (data) {
                        ...
                        cubit.getAllHistory(cubit.userDetailsModel!.data!.id);
                      },
                    ),
                  );
                },
