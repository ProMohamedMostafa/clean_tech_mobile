              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: cubit
                          .getStatusColorForType(cubit.selectedIndex == 0
                              ? cubit.transactionManagementModel!.data!
                                  .data![index].typeId!
                              : cubit.selectedIndex == 1
                                  ? cubit.transactionManagementInModel!.data!
                                      .data![index].typeId!
                                  : cubit.transactionManagementOutModel!.data!
                                      .data![index].typeId!)
                          .withOpacity(0.2),
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyles.font11WhiteSemiBold.copyWith(
                          color: cubit.getStatusColorForType(
                              cubit.selectedIndex == 0
                                  ? cubit.transactionManagementModel!.data!
                                      .data![index].typeId!
                                  : cubit.selectedIndex == 1
                                      ? cubit.transactionManagementInModel!
                                          .data!.data![index].typeId!
                                      : cubit.transactionManagementOutModel!
                                          .data!.data![index].typeId!),
                        ),
                      ),
                    ),
                  ...
                  if ((cubit.selectedIndex == 0 &&
                    ...
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: S.of(context).totalPriceLabel,
                            style: TextStyles.font12GreyRegular,
                          ),
                          TextSpan(
                            text:
