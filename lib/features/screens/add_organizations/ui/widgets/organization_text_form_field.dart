...
class OrganizationTextFormField extends StatefulWidget {
  ...
  const OrganizationTextFormField({
    super.key,
    required this.items,
  ...
  @override
  State<OrganizationTextFormField> createState() =>
      _OrganizationTextFormFieldState();
}

class _OrganizationTextFormFieldState extends State<OrganizationTextFormField> {
